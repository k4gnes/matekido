...
Ennek a forgatókönyvnek a célja, hogy a **félretett (kihagyott / ⏭️ átugrott) feladatok** viselkedését a böngészőben kézzel végigellenőrizzük, és hogy mindenki számára érthető legyen: **miért éppen az a „következő feladat”, ami**. A dokumentum az aktuális (2026-09-18 utáni) viselkedést írja le.
...
- A félretételnek **két külön nyilvántartása** van: az **osztály menete** és a **🎛️ Saját lista**. Az egyikben félretett feladat a másikban **nem** számít kihagyottnak; ha akárhol megoldod, onnantól **mindenhol** lekerül.
- A **⏭️** **már megoldott** feladatnál nem tesz félre semmit – csak továbblép.
...
### 4b. Saját lista – külön kontextus

| # | Lépés | Várt eredmény | Eredmény |
|---|-------|---------------|----------|
| 4b.1 | Lépj a **🎛️ Saját lista** fülre (pl. 1. osztály szűrővel), indíts el egy **megoldatlan** feladatot, és a jelenetén ⏭️ | Félrekerül a **saját listás** nyilvántartásba; a Saját lista nézetben megjelenik a **„⏭️ Átugrott feladatok (1)”** szekció | |
| 4b.2 | Lépj át az **osztályos** nézetre | A feladat **nem** jelenik meg az osztályos Átugrott szekcióban – a két nyilvántartás külön van | |
| 4b.3 | A Saját lista **➡️ Következő feladat** ajánlója | A félretett feladatot átugorja, amíg van más megoldatlan a listában; a **végén** jön vissza | |
| 4b.4 | A Saját listában félretett feladatot **bárhonnan indítva oldd meg** | Lekerül a saját listás nyilvántartásból; az osztályos Átugrott szekciót sem érinti | |
