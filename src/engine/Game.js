...
import { renderSpatial } from "../components/spatial.js?v=13";
...
import { renderMultPrep } from "../components/multPrep.js?v=5";
...
import { renderEstimate } from "../components/estimate.js?v=5";
import { renderTrueFalse } from "../components/trueFalse.js?v=5";
import { renderFindError } from "../components/findError.js?v=2";
import { renderShapeCompare } from "../components/shapeCompare.js?v=2";
