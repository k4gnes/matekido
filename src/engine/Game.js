...
import { renderSpatial } from "../components/spatial.js?v=29";
...
import { renderWordProblem } from "../components/wordProblem.js?v=21";
...
import { renderSetMatch } from "../components/setMatch.js?v=2";
...
import { renderWrittenDivision } from "../components/writtenDivision.js?v=3";
